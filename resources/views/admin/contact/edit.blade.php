    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('contact.editPost',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <!-- text input -->
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Tên</label>
                                    <input type="email" name="email" value="{{$data->email}}" class="form-control" placeholder="Enter ..."
                                        value="{{ old('email') }}">
                                    @error('email')
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Tên</label>
                                    <input type="tel" name="tel" value="{{$data->tel}}" class="form-control" placeholder="Enter ..."
                                        value="{{ old('tel') }}">
                                    @error('tel')
